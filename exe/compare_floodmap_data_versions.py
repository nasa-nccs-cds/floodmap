...
data_loc = "/att/pubrepo/ILAB/projects/Birkett/MOD44W/results"
year = 2021
days = [0,260]
...
for day in days:
    ...
    nrt_data_file = f"{data_loc}/{nrt_tile}/allData/61/MCDWD_L3_F2_NRT/Recent/MCDWD_L3_F2_NRT.A{year}{day:03}.{nrt_tile}.061.tif"
