...
lake_index = 66                  #  [4, 5, 9, 11, 12, 14, 19, 21, 22, 26, 28, 37, 42, 43, 44, 51, 53, 60, 66, 67, 69, 73, 74, 76, 79, 81, 82, 85, 87, 88, 91, 93, 97, 99]
day = 274
...
if not os.path.isfile( water_map_file ):
    ...
    lakeMaskProcessor.process_lakes( multiproc=False )
...
probe_arrays = OrderedDict( water_counts=water, land_counts=land, result=floodmap )
